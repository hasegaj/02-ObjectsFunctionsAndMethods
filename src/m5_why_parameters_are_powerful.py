...
def main():
    ...
    better_draw_circles(rg.Point(10, 5), 28)
    even_better_draw_circles(rg.Point(0, 0), 34, 6, 'blue', 17)
...
def even_better_draw_circles(point, radius, number_of_circles, what_color, thicc):
    #
    ...
    for k in range(1, number_of_circles): # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_up()
        turtle.pen = rg.Pen(what_color, thicc)
...
# Question:
# I'm confused, do I get rid of the previous even_better_draw_circles or just add new code?
# I have left it with the single use of even_better_draw_circles, but am unsure if this is what I should do
